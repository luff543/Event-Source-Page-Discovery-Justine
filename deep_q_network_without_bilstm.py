...
class Qnet(keras.Model):
    def __init__(self,tagdimension):
        ...
        self.at_embedding_first = layers.Dense(768, kernel_initializer='he_normal', activation='relu')
        self.at_embedding_two = layers.Dense(768, kernel_initializer='he_normal', activation='relu')
        self.at_embedding_three = layers.Dense(256, kernel_initializer='he_normal', activation='relu')
...
class Agent():
    ...
    def step(self,action_url,TrainFeatures,epsilon,step,env):
        ...
        tmpatembedding, tmpCoordinate, tmptagid, tmptagindex = Tool.ProcessFeatures(tmpAT, tmpCoordinate,
...
if __name__ == '__main__':
    ...
    print_interval = 5
    numofthread = 2
    savemodelname = "pretrain_dqn_without_bilstm_cost0.4_fixreward"
    savemodelname_dir = 'pretrain_dqn_without_bilstm_cost0.4_fixreward'
