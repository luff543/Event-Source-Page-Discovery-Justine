    ...
    def saveReward(self,stepreward,cost,t,types):
        ...
        if not os.path.exists(path):
            ...
            with open('{}/{}/reward/reward_{}.csv'.format('precision_result', savemodelname, types), 'w',
                ...
                writer.writerow(['step reward','cost','step'])
    ...
    def updatetobuffer(self,pre_s,url,pre_coor,types,env):
        ...
        # for t in range(6):  # 一個回合最大時間戳 (updating N times)
            ...
            if s_prime_count >= 3:
                ...
                top3_data.clear()
                break
            s_prime, r,next_coor = self.step(current_url, s, t,env)
            ...
            memory.put((s, action_idx, r, s_prime, action_idx_, pre_coor))
    ...
    for i in range(10):  # 訓練10次
        ...
        with tf.GradientTape() as tape:  # 在 tf GradientTape 區塊一次為一個批次進行預測
            for transition in mini_batch:
                s, a, r, s_prime, a_,coor = transition
...
if __name__ == '__main__':
    ...
    pretrainmodel = './stepnofixmodel/pretrain_SARSA_step_nofix_bertbisltm_top3_cost0.4_fixreward_choose.h5'
    # Hyperparameters
    ...
    print_interval = 5
    numofthread = 2
    savemodelname = "finetune_SARSA_no_pre_train_nofixstep_eplision_0.3"
    savemodelname_dir = 'finetune_SARSA_no_pre_train_nofixstep_eplison_0.3'
